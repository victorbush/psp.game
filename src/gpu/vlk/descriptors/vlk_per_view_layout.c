...
static void create_descriptor_pool(_vlk_per_view_layout_t* layout);

/** Creates the descriptor set layout. */
static void create_layout(_vlk_per_view_layout_t* layout);

/** Destroys the descriptor pool. */
static void destroy_descriptor_pool(_vlk_per_view_layout_t* layout);

/** Destroys the descriptor set layout. */
static void destroy_layout(_vlk_per_view_layout_t* layout);
